...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        XXXXXXX, KC_LGUI, KC_LALT, MO(1),   KC_BSPS,      KC_SPC,       MO(1),   KC_RALT, KC_RGUI, XXXXXXX
    ),
    [1] = LAYOUT(
    ...
    [2] = LAYOUT(
        ...
        XXXXXXX, _______,      _______,      XXXXXXX,       KC_ESC,                       KC_BSPC,                XXXXXXX,    _______,    _______,    XXXXXXX
    ),
};
